        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            ...
            <form onSubmit={onSubmitHandler}>
                <div className='mb-3 min-w-72'>
                    <p className='text-lg font-medium text-gray-700 mb-2'>Email Address</p>
                ...
                <button className='text-lg mt-4 w-full py-2 px-4 rounded-md text-white bg-black cursor-pointer' type="submit"> Login </button>
            </form>
        </div>
    </div>
  )
