...
export default function DatesPage() {
  ...
  // ✅ useEffect to filter products automatically
  useEffect(() => {
    const result = products.filter((product) => product.category === "Dates");
            ...
            >
              ...
              <div className="p-4 text-center">
                ...
                <button
                  ...
                  onClick={() => navigate(`/product/dates/${product._id}`)}
                >
